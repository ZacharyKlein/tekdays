                ...
                <table>
                    ...
                    <g:each in="${volunteerInstanceList}" status="i" var="volunteerInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${volunteerInstance.user.profile?.fullName ?: volunteerInstance.user.username}</td>

                            <td><g:formatDate format="EEEEE, MMMM dd, yyyy" date="${volunteerInstance.lastUpdated}"/> at <g:formatDate format="hh:mm aa" date="${volunteerInstance.lastUpdated}"/></td>
