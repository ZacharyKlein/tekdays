<html>  <head>
  ...
  <body>
    ...
    <div class="eventBody">
        ...
        <div id="eventContent" style="float:left">
              <h1>${tekEventInstance.name}</h1>
              <g:if test="${flash.message}">
                <div class="message">${flash.message}</div>
              </g:if>
        ...
        <div id="eventSecondaryContent" style="float:right"">
              <div id="grayBox">
...
<<<<<<< HEAD:grails-app/views/tekEvent/show.gsp
            <td:ifIsAssociated id="${tekEventInstance?.id}">

            <g:actionSubmit class="edit" value="Edit Event Details" action="edit" />
=======
                    <g:actionSubmit class="edit" value="Edit Event Details" action="edit" />
>>>>>>> 20da8fc6c7b8aa21876eccd7d26215a6b392f792:grails-app/views/tekEvent/show.gsp
