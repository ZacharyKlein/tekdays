...
<!--    <h2>&nbsp; Search Results</h2>-->
    ...
    <li><td:displayAd /></li>
      <g:if test="${events}">
		...
		<link:eventHome slug="${event?.slug}"><img src="${createLink(action:'displayLogo', controller:'tekEvent', params:['slug':event.slug])}" style="float:left; margin:10px" width="80" height="80"/></link:eventHome>
