	              <g:each in="${organizerEvents}" var="event" status="i">
	                <div class="associatedEvent">
	                  <link:eventHome slug="${event?.slug}"><img height="80" width="80" src="${createLink(action:'displayLogo', controller:'tekEvent', params:['slug':event.slug])}" style="float:left; margin:10px"/></link:eventHome>
